...
const chatUsersCount = document.querySelector(".users-count");
const sendMessageForm = document.querySelector("#messageForm");
const MessageInput = document.querySelector("#MessageInput");
const chatMessages = document.querySelector("#chatContent");
const groupName = document.querySelector(".chat-group-title");
...
function onConnectionOpen() {
  ...
  groupName.textContent = queryParams.group;
...
function OnMessageReceived(event) {
  ...
  switch (event.event) {
    ...
    case "message":
      ...
      scrollPos = chatMessages.offsetHeight + chatMessages.scrollTop;
